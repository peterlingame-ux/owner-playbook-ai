...
INSERT INTO league_constants (chinese_name, english_name) VALUES
  ...
  ('葡萄牙超级杯', 'Taça de Portugal'),
  ('沙特超级联赛', 'Saudi Professional League'),
  ('卡塔尔甲级联赛', 'Qatar Stars League'),
  ('埃及杯', 'Egypt Cup'),
  ('澳大利亚甲级联赛', 'A-League'), 
  ('土耳其杯', 'Turkish Cup'),
  ('世界杯', 'FIFA World Cup'),
  ('瑞士超级联赛', 'Swiss Super League'),
  ('俄罗斯足球超级联赛', 'Russian Premier League'),
  ('比利时甲级联赛A', 'Jupiler Pro League'),
  ('欧洲联赛', 'UEFA Europa League'),
  ('日本J1联赛', 'J1 League'),
  ('日本J2联赛', 'J2 League'),
  ('韩国K1联赛', 'K League 1'),
  ('美国职业足球联赛', 'Major League Soccer'),
  ('荷兰足球甲级联赛', 'Eredivisie'),
  ('波兰足球超级联赛', 'Ekstraklasa'),
  ('英格兰足总杯', 'FA Cup'),
  ('非洲国家杯', 'Africa Cup of Nations'),
  ('梦幻对垒', 'Fantasy Showdown'),
  ('葡萄牙联赛杯', 'Taça da Liga'),
  ('土耳其超级杯', 'Turkish Super Cup'),
  ('非洲国家杯2025(在摩洛哥)', 'Africa Cup of Nations 2025')
