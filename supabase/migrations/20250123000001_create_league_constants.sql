...
INSERT INTO league_constants (chinese_name, english_name) VALUES
  ...
  ('日本职业足球甲级联赛', 'J1 League'),
  ('日本职业足球乙级联赛', 'J2 League'),
  ('日本足球联赛', 'Japan Football League'),
  ('比利时甲级联赛', 'Jupiler Pro League'),
  ('韩国职业甲级足球联赛', 'K League 1'),
  ('韩国职业乙级足球联赛', 'K League 2'),
  ('西班牙甲级联赛', 'La Liga'),
  ('中国足球甲级联赛', 'League One'),
  ('英格兰乙级联赛', 'League Two'),
  ('葡萄牙乙级联赛', 'Liga 3'),
  ...
  ('沙特阿拉伯超级联赛', 'Saudi Professional League'),
  ('卡塔尔联赛', 'Qatar Stars League'),
  ('埃及杯', 'Egypt Cup'),
  ('土耳其杯', 'Turkish Cup'),
  ('世界杯', 'FIFA World Cup'),
  ('瑞士超级联赛', 'Swiss Super League'),
  ('俄罗斯超级联赛', 'Russian Premier League'),
  ('日本职业足球甲级联赛（J1）', 'J1 League'),
  ('日本职业足球乙级联赛（J2）', 'J2 League'),
  ('英格兰足总杯赛', 'FA Cup'),
