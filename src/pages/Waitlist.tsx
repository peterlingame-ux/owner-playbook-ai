    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 items-start justify-center">
            ...
            <div className="flex-1 w-full">
              ...
              >
                <SelectTrigger className="h-14 text-base border-2 bg-background">
            ...
            <Button type="submit" className="h-14 px-8 text-base font-medium">
              JOIN
            </Button>
          </form>
        </div>
