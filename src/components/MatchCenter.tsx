...
import { Star, Flame, Play, Loader2 } from "lucide-react";
        ...
        <div className="divide-y divide-border/20">
          {isLoadingMatches ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 px-4">
              <div className="text-sm text-destructive font-medium mb-2">加载失败</div>
              <div className="text-xs text-muted-foreground text-center mb-4">{matchesError}</div>
              <button
                onClick={handleAllTabClick}
