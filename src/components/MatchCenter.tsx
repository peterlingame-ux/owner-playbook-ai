  ...
  const MatchCard = ({ match }: { match: VirtualMatch }) => (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-1.5 sm:mb-3 gap-1">
        <div className="flex items-center gap-1 sm:gap-2 min-w-0 flex-1">
          <div className="flex items-center gap-1">
            <Trophy className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-amber-500/80 flex-shrink-0" />
      ...
      <div className="flex items-center gap-1 sm:gap-3">
        ...
        <div className="flex-shrink-0 min-w-[44px] sm:min-w-[70px] flex flex-col items-center">
          ...
          return (
            ...
            >
              <TabIcon className={cn(
                "w-3 h-3 sm:w-3.5 sm:h-3.5 transition-colors flex-shrink-0",
