  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative min-h-[220px] sm:min-h-[260px] lg:min-h-[300px]">
        ...
        <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-96 h-96 bg-amber-500/10 rounded-full blur-[120px] pointer-events-none"/>
        ...
        <div className="relative z-10 container mx-auto px-4 py-10 sm:py-12 lg:py-14 flex flex-col items-center justify-center text-center">
          ...
          {/* Main Title */}
          <h1 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold text-foreground/90 mb-5 leading-relaxed max-w-3xl">
