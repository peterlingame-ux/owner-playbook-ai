        ...
        <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-20 flex items-center gap-2 sm:gap-3">
          ...
          >
            ...
            <div className="hidden sm:flex flex-col">
              <span className="text-[7px] text-white/70 leading-tight uppercase tracking-wide">{t('common.get_it_on', 'GET IT ON')}</span>
              <span className="text-[10px] font-medium text-white leading-tight">{t('common.google_play', 'Google Play')}</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="hidden sm:flex flex-col">
              <span className="text-[7px] text-white/70 leading-tight">{t('common.available_on', 'Available on the')}</span>
              <span className="text-[10px] font-medium text-white leading-tight">{t('common.app_store', 'App Store')}</span>
            </div>
          </a>
        </div>
