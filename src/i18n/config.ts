...
const resources = {
  en: {
    translation: {
      ...
      "bet_type_handicap": "Handicap Index",
      "bet_type_over_under": "Goals Index",
      "profit": "Profit",
      "loss": "Loss",
      ...
      "disclaimer_text": "HUNSOCCER is solely for testing AI analysis capabilities and must not be used for any gambling activities. AI prediction results do not involve any real transactions.",
  ...
  zh: {
    translation: {
      ...
      "copy_trade": "模型跟单",
      "coming_soon": "即将开放",
      "copy_trade_unavailable": "模型跟单功能暂未开放",
      ...
      "disclaimer_text": "HUNSOCCER仅测试不同AI的分析能力，不可用于一切赌博行为，AI预测结果，不参与一切真实交易",
