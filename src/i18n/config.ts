...
const resources = {
  ...
  zh: {
    translation: {
      ...
      "featured_winners": "获奖预测者案例",
      "featured": "精选",
      "player_win_rate": "预测者胜率",
  ...
  ko: {
    translation: {
      ...
      "challenge_description": "예측 수, 정확도, 시뮬 포인트가 제한 시간 내에 1위 AI 모델을 모두 초과하면 무료로 상금을 받을 수 있습니다",
      "ai_benchmark": "AI 기준",
      "banner_predictions": "예측:",
      "banner_win_rate": "정확도:",
      "banner_profit": "시뮬 포인트:",
      ...
      "view_details": "상세 보기",
      // AI Analysis Section
      "ai_analysis_title": "HUNSOCCER 실시간 경기 지능 분석",
      "ai_analysis_disclaimer": "실시간 영상 인식 및 통계 모델 출력 데이터입니다. 지연 및 오류가 있을 수 있으며, 전술 분석 참고용입니다.",
      ...
      "danger_zone": "위험한 공격",
      "danger_entries": "회",
      "pressure_analysis": "압박 & 전환",
      "pressure_index": "압박 강도",
      "high_press": "하이 프레스",
      "counter_attack": "전환 기회",
      "counter_chances": "회",
      "legend_home": "홈",
      "legend_away": "원정",
      "legend_pass": "패스/런 라인",
      ...
      "subscribed_model": "{{model}} 구독 완료, {{amount}} 헌터 코인 투자",
      "subscribe_failed": "구독 실패",
      "login_first": "먼저 로그인하세요",
      "login_to_subscribe": "AI 모델을 구독하려면 로그인하세요",
      "fetch_analysis_failed": "분석 가져오기 실패",
      "cannot_fetch_analysis": "분석 데이터를 가져올 수 없습니다",
      "no_analysis_found": "분석을 찾을 수 없음",
      "no_analysis_data": "이 경기에 대한 AI 분석 데이터가 없습니다",
