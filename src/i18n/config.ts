...
const resources = {
  en: {
    translation: {
      ...
      "time_week": "Week",
      "time_month": "Month",
      "stats_range": "Statistics Range",
      "time_range_utc8": "Based on Beijing time (UTC+8)",
      ...
      "max_prize": "MAX PRIZE",
      "join_competition": "Sign Up / Login",
      ...
      "estimated": "Est.",
      "reach_qualification_for_prize": "Reach qualification to share prize",
      "match_tab_all": "All",
      "match_tab_live": "Live",
      "match_tab_upcoming": "Upcoming",
      "match_tab_finished": "Results",
      "match_tab_favorites": "Favorites",
      ...
      "cancel_copy_trade": "Unsubscribe",
      "only_one_copy_trade_model": "Only one AI model can be followed at a time. Please unsubscribe first, then choose another.",
      "cancel_copy_trade_success": "Unsubscribed successfully",
      "cancel_copy_trade_failed": "Failed to unsubscribe, please try again",
      "cancelling": "Unsubscribing…",
      "stake_per_bet_label": "Stake per copy",
      "ai_copy_trade_note": "After subscribing, the system will automatically copy this AI's new bets at your set stake (handicap/over-under only).",
      "invalid_amount": "Invalid amount",
      "stake_range_hint": "Stake must be between 10 and 10000 Hunter Coins.",
      "subscribe_failed": "Subscribe Failed",
      "subscribe_placeholder_only": "This item is demo data and cannot be subscribed",
      ...
      "free_trial_expired_contact": "Free trial has expired. Please contact customer service.",
      "free_trial_7_days_title": "7-Day Free Trial",
      "free_trial_7_days_desc": "You have 7 days of free trial to enjoy all features.",
      "free_trial_ends_at": "Trial ends at",
      "contact_customer_service": "Contact Customer Service",
      "trial_dialog_continue": "Get Started",
      "login_now": "Login Now",
      "follow": "Follow",
      "followers": "Followers",
      ...
      "auth": {
        ...
        "invitation_code_hint": "(Get Star Card for every 5 invites)",
        ...
        "no_password_set": "Please set password first",
        ...
        "please_login": "Please login directly",
        "detected_new_user": "New User Detected",
        "complete_registration": "Please switch to registration mode to complete registration"
      },
      ...
      "manual_prediction_disabled_by_copy_trade": "You have auto copy trade enabled. Manual prediction is not available. Please unsubscribe in the leaderboard first.",
      ...
      "manual_bet_title": "Manual Bet",
      "no_handicap_odds": "No handicap odds",
      "no_over_under_odds": "No over/under odds",
      "bet_hunter_coin": "Bet Hunter Coins",
      "max_prefix": "Max",
      "fetch_matches_failed": "Failed to fetch matches",
      "select_prediction_option": "Please select prediction",
      "enter_bet_amount_hint": "Please enter bet amount",
      "prediction_submit_success": "Prediction submitted",
      ...
      // PlaceBetDialog specific
      "bet_success_title": "Bet Successful",
      "bet_placed": "Bet",
      "virtual_wallet_balance": "Virtual Wallet Balance",
      "demo_mode": "Demo",
      "ai_predictions_today": "Today's AI predicted matches, updated daily",
      "match_started": "Started",
      "select_match_title": "Select Match",
      "place_bet_title": "Place Bet",
      "enter_amount": "Enter amount",
      "balance_label": "Balance",
      "try_bet": "Try Bet",
      "confirm_bet_btn": "Confirm Bet",
      "min_subscribe_amount": "Minimum subscription is 10 PTS",
      "subscribe_success_demo": "Demo Mode: Subscribe Success",
      "insufficient_balance_subscribe": "Insufficient balance for subscription",
      "unlock_cost": "Unlock Cost",
      "current_balance_short": "Current Balance",
      "hunter_coins_unit": "Hunter Coins",
      "subscribe_amount": "Subscribe Amount",
      "expected_profit_label": "Expected Profit",
      "available_balance": "Available",
      "insufficient_balance_short": "Insufficient balance, current available",
      "min_amount_hint": "Minimum amount is",
      "subscribe_to_view": "Subscribe to view match details",
      ...
      "no_copy_trade_subscribers": "No users subscribed to auto copy yet",
      "no_copy_trade_subscribers_hint": "Subscribe to an AI model under AI leaderboard to appear here",
      ...
      "star_cards_exchange_vip": "2 star cards can be exchanged for 1 month free VIP",
      ...
      "membership_remaining": "Remaining",
      "membership_expired": "Expired",
      "nav_ai_bet": "AI Today",
      "not_vip": "Trial expired",
      "invite_to_get_vip": "Invite friends to get VIP for free",
  ...
  zh: {
    translation: {
      ...
      "time_month": "月",
      "stats_range": "统计范围",
      "time_range_utc8": "按北京时间（UTC+8）统计",
      "today_data": "今日数据",
      "weekly_data": "本周数据",
      "monthly_data": "本月数据",
      "all_players": "全部预测者",
      ...
      "predictor_exclusive_model": "专属模型",
      ...
      "leading_player": "领先玩家",
      "active_matches": "活跃比赛",
      "league_premier_league": "英超联赛",
      "league_la_liga": "西甲联赛",
      "league_bundesliga": "德甲联赛",
      "win_rate_label": "胜率",
      ...
      "subscribed_model": "已开启 {{model}} 自动跟单，每笔 {{amount}} 猎人币",
      "subscribed": "已订阅",
      "cancel_copy_trade": "取消跟单",
      "only_one_copy_trade_model": "仅支持同时跟单一个模型，请先取消当前跟单后再选择其他。",
      "cancel_copy_trade_success": "已取消跟单",
      "cancel_copy_trade_failed": "取消失败，请重试",
      "cancelling": "取消中…",
      "stake_per_bet_label": "每笔跟单金额",
      "ai_copy_trade_note": "订阅后，该 AI 每次新下注时系统将自动以您设置的金额跟单（仅让球/大小球）",
      "invalid_amount": "金额无效",
      "stake_range_hint": "每笔跟单金额须在 10～10000 猎人币之间",
      "subscribe_failed": "订阅失败",
      "subscribe_placeholder_only": "该条为展示数据，暂不可订阅",
      "login_first": "请先登录",
      ...
      "free_trial_expired": "免费试用已到期",
      "free_trial_expired_contact": "免费试用已到期，请联系客服",
      "free_trial_7_days_title": "7天免费试用",
      "free_trial_7_days_desc": "您享有7天免费试用，畅享全部功能。",
      "free_trial_ends_at": "试用截止时间",
      "contact_customer_service": "联系客服",
      "trial_dialog_continue": "开始使用",
      "login_now": "立即登录",
      "follow": "关注",
      "followers": "关注者",
      "followed": "关注成功",
      ...
      "auth": {
        ...
        "invitation_code": "邀请码",
        "invitation_code_hint": "（每邀请5人赠送球星卡）",
        ...
        "please_register_first": "请先注册",
        "user_already_exists": "用户已存在",
        "please_login": "请直接登录",
        "detected_new_user": "检测到新用户",
        "complete_registration": "请切换到注册模式完成注册"
      },
      "copy_trade": "关注模型",
      ...
      "manual_prediction_disabled_by_copy_trade": "您已开启自动跟单，无法同时使用人工预测。请先在排行榜取消跟单后再试。",
      ...
      "manual_bet_title": "人工下注",
      "no_handicap_odds": "暂无让分赔率数据",
      "no_over_under_odds": "暂无大小球赔率数据",
      "bet_hunter_coin": "投注猎人币",
      "max_prefix": "最多",
      "fetch_matches_failed": "获取比赛列表失败",
      "select_prediction_option": "请选择预测选项",
      "enter_bet_amount_hint": "请输入投注金额",
      "prediction_submit_success": "预测提交成功",
      "unknown_league": "未知联赛",
      "handicap_line": "让球盘口",
      ...
      "hunter_coin_disclaimer": "猎人币是站内模拟币，用于记录与展示预测行为带来的模拟结果。猎人币不代表任何法币或虚拟货币，也不具备金融属性。猎人币为免费发放，新注册用户获得100,000，不可购买。猎人币不可提现、不可兑换现金或任何等价物。猎人币不可转让、不可交易、不可在站外流通。猎人币仅用于平台内的模拟与展示用途。",
      "view_analysis": "AI分析",
      "model_training": "模型训练",
      "data_feeding": "数据投喂",
      "times_training": "次训练",
      ...
      // PlaceBetDialog specific
      "bet_success_title": "投注成功",
      "bet_placed": "投注",
      "virtual_wallet_balance": "虚拟钱包余额",
      "demo_mode": "演示",
      "ai_predictions_today": "以下为今日AI预测比赛，每日更新",
      "match_started": "已开赛",
      "select_match_title": "选择比赛",
      "place_bet_title": "下注",
      "enter_amount": "输入金额",
      "balance_label": "余额",
      "try_bet": "体验投注",
      "confirm_bet_btn": "确认投注",
      "min_subscribe_amount": "最低订阅金额为 10 PTS",
      "subscribe_success_demo": "演示模式：订阅成功",
      "insufficient_balance_subscribe": "余额不足，无法订阅",
      "unlock_cost": "解锁费用",
      "current_balance_short": "当前余额",
      "hunter_coins_unit": "猎人币",
      "subscribe_amount": "订阅金额",
      "expected_profit_label": "预期收益",
      "available_balance": "可用余额",
      "insufficient_balance_short": "余额不足，当前可用余额为",
      "min_amount_hint": "最低金额为",
      "subscribe_to_view": "订阅后查看比赛详情",
      ...
      "no_copy_trade_subscribers": "暂无订阅自动跟单的用户",
      "no_copy_trade_subscribers_hint": "在 AI 预测排行榜中点击「自动跟单」订阅后，将显示在此",
      ...
      "max_file_size": "支持 JPG, PNG (最大2MB)",
      "click_to_change": "点击更换",
      "file_too_large": "文件过大，最大2MB",
      ...
      "to_next_level": "升级还需",
      "loading_matches": "加载比赛中...",
      "no_matches": "暂无比赛",
      "retry": "重试",
      "soon": "即将",
      "match_tab_all": "全部",
      "match_tab_live": "进行中",
      "match_tab_upcoming": "赛程",
      "match_tab_finished": "赛果",
      "match_tab_favorites": "关注",
      "prize_share": "平分奖金",
      "estimated": "预估",
      "reach_qualification_for_prize": "达标后可参与奖金分配",
      "max_level": "满级",
      ...
      "star_cards_exchange_vip": "两张球星卡可换取一个月免费VIP",
      ...
      "membership_expires": "会员到期",
      "membership_remaining": "剩余",
      "membership_expired": "已过期",
      "nav_ai_bet": "AI今日推荐",
      "not_vip": "试用已到期",
      "invite_to_get_vip": "免费邀请获取VIP",
