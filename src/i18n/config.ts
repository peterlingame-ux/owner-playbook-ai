...
const resources = {
  en: {
    translation: {
      ...
      "formation_monitoring": "Formation Monitoring",
      "distance_tracking": "Distance",
      "pass_distance_monitoring": "Pass Distance",
      "meters_per_pass": "m/avg pass",
      "speed_tracking": "Speed",
      "player_speed_monitoring": "Player Speed",
      "kmh_max_speed": "km/h max",
      "data_analysis": "Analysis",
      "attack_intent_analysis": "Attack Intent",
      "high_attack_intent": "High Intent",
      "ai_prediction_label": "AI Predict",
      "passing_route_prediction": "Route Prediction",
  ...
  zh: {
    translation: {
      ...
      "active_players": "活跃球员",
      "ai_recognition": "AI识别",
      "formation_monitoring": "当前阵型监测",
      "distance_tracking": "距离追踪",
      "pass_distance_monitoring": "传球距离监测",
      "meters_per_pass": "米/平均传球",
      "speed_tracking": "速度追踪",
      "player_speed_monitoring": "球员时速监测",
      "kmh_max_speed": "km/h 最高速度",
      "data_analysis": "数据分析",
      "attack_intent_analysis": "进攻欲望分析",
      "high_attack_intent": "高进攻意图",
      "ai_prediction_label": "AI预测",
      "passing_route_prediction": "传导路线预测",
      "optimal_routes": "最优路线",
  ...
  ko: {
    translation: {
      ...
      "formation_monitoring": "포메이션 모니터링",
      "distance_tracking": "거리",
      "pass_distance_monitoring": "패스 거리",
      "meters_per_pass": "m/평균",
      "speed_tracking": "속도",
      "player_speed_monitoring": "선수 속도",
      "kmh_max_speed": "km/h 최고",
      "data_analysis": "분석",
      "attack_intent_analysis": "공격 의도",
      "high_attack_intent": "높은 의도",
      "ai_prediction_label": "AI 예측",
      "passing_route_prediction": "경로 예측",
      "optimal_routes": "최적",
