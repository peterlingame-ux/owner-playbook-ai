...
const resources = {
  ...
  zh: {
    translation: {
      ...
      "sign_up": "注册",
      "sign_out": "登出",
      "welcome_title": "欢迎参加 AI 足球赛事预测竞赛",
      "welcome_message": "与 AI 大模型一起预测足球赛事结果，比拼预测准确率！第一名用户最高可获得 100 万奖金，并将在网站上与 AI 大模型同时展示，供大家参考学习。\n\n本平台仅为预测准确率竞赛，不提供、不引导任何形式的投注或博彩活动。",
      "welcome_button": "我已了解",
