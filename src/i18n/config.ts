...
const resources = {
  en: {
    translation: {
      ...
      "exclusive_ai_model": "EXCLUSIVE AI MODEL",
      "exclusive_ai_desc": "Premium AI with highest prediction accuracy",
      "roi": "ROI",
      "model_energy": "Model Energy",
      "feed_model": "Feed Model",
      "feed_success": "Feed Success!",
      "feed_success_desc": "Model energy increased by 10%",
      "model_full": "Model Full",
      "model_full_desc": "The model is at maximum energy level",
      ...
      "active_ai_predictions": "AI FOOTBALL TODAY'S PREDICTIONS",
  ...
  zh: {
    translation: {
      ...
      "copy_trade": "关注模型",
      "coming_soon": "即将开放",
      "exclusive_ai_model": "专属AI模型",
      "exclusive_ai_desc": "最高预测准确率的专业AI",
      "roi": "收益率",
      "model_energy": "模型能量",
      "feed_model": "喂养模型",
      "feed_success": "喂养成功！",
      "feed_success_desc": "模型能量增加10%",
      "model_full": "模型已满",
      "model_full_desc": "模型已达到最大能量值",
      "copy_trade_unavailable": "关注模型功能暂未开放",
      "copy_trade_unavailable_desc": "关注模型功能即将上线，敬请期待！",
      "locked_model": "已锁定",
      "locked_model_message": "该模型已锁定，敬请期待开放！",
      "active_ai_predictions": "AI足球赛事今日预测",
      "prediction": "预测",
      "current_score": "当前比分",
      "bet_amount": "模拟额度",
      "balance": "账户余额",
