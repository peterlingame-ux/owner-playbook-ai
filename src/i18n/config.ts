...
const resources = {
  en: {
    translation: {
      ...
      "hot_players": "Hot Streak",
      "cold_players": "Cold Streak",
      "sorted_by_streak": "Sorted by streak",
      "sorted_by_lose_streak": "Sorted by lose streak",
      "realtime_update": "Real-time update",
      "players_suffix": "players",
      "loading_players": "Loading players...",
      "view_all_players": "View all players",
      "no_signature": "No signature yet",
      "win_streak_suffix": " wins",
      "lose_streak_suffix": " losses",
      "profit_pts": "Profit (PTS)",
