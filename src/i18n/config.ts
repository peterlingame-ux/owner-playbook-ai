...
const resources = {
  en: {
    translation: {
      ...
      "correct": "CORRECT",
      "wrong": "WRONG",
      "player_exclusive_model": "Player Exclusive Model",
      "login_to_generate_model": "Login to Generate Model",
  ...
  zh: {
    translation: {
      ...
      "correct": "正确",
      "wrong": "错误",
      "player_exclusive_model": "预测者专属模型",
      "login_to_generate_model": "登录后生成专属模型",
      "train_model": "训练模型",
      "performance": "表现",
