...
const resources = {
  en: {
    translation: {
      ...
      // Daily Prize Page
      "daily_prize_tag": "Daily Lucky Draw",
      "daily_prize_hero_title": "Daily Predictions, Daily Prizes",
      "daily_prize_hero_desc": "Complete daily prediction tasks to enter the daily prize draw. Win iPhone, MacBook, PS5 and more!",
      "daily_step1_title": "Complete Daily Predictions",
      "daily_step1_desc": "Complete 5 match predictions daily to qualify. Higher accuracy means better winning chances.",
      "daily_step2_title": "Achieve Win Rate Target",
      "daily_step2_desc": "Daily prediction accuracy must reach 50% or above to participate in the 21:00 prize draw.",
      "daily_step3_title": "Claim Your Prize",
      "daily_step3_desc": "Winners will be notified automatically. Claim your prize within 7 days or it expires.",
      "daily_prizes_section": "Daily Prizes",
      "daily_draw_time_hint": "Draw at 21:00 daily, complete predictions to participate",
      "daily_past_days": "Past",
      "countdown_to_draw": "Countdown to Today's Draw",
      "countdown_hours": "HOURS",
      "countdown_minutes": "MINS",
      "countdown_seconds": "SECS",
      "daily_draw_at_21": "Daily draw at 21:00",
      "join_now_btn": "Join Now",
      "day_prize_detail": "Day {{day}} Prize Details",
      "daily_prize_label": "Today's Prize",
      "winner_info": "Winner Info",
      "draw_time": "Draw Time",
      "no_winner": "No Winner",
      "waiting_draw": "Awaiting Draw",
      "tonight_21_draw": "Tonight 21:00 Draw",
      "daily_disclaimer_text": "This event is a virtual prediction competition hosted by HUNSOCCER. All prize draws are randomly generated and not related to gambling. Participants must be 18+. Final interpretation rights belong to HUNSOCCER. Prize claims require identity verification and address confirmation within 7 days.",
      "daily_today": "Today",
      ...
      "challenge_ai_reward": "Challenge AI Reward",
  ...
  zh: {
    translation: {
      ...
      // Daily Prize Page
      "daily_prize_tag": "每日幸运抽奖",
      "daily_prize_hero_title": "每日竞猜，赢取大奖",
      "daily_prize_hero_desc": "完成每日预测任务，即可参与当日奖品抽取，iPhone、MacBook、PS5 等你来拿！",
      "daily_step1_title": "完成每日预测",
      "daily_step1_desc": "每日完成5场比赛预测，即可获得抽奖资格。预测越准确，中奖概率越高。",
      "daily_step2_title": "达成胜率要求",
      "daily_step2_desc": "当日预测准确率需达到50%及以上，方可参与当晚21:00的奖品抽取。",
      "daily_step3_title": "领取专属奖品",
      "daily_step3_desc": "中奖后系统将自动通知您，请在7日内完成奖品领取，逾期作废。",
      "daily_prizes_section": "每日奖品",
      "daily_draw_time_hint": "每天21:00准时开奖，完成预测即可参与",
      "daily_past_days": "已过",
      "countdown_to_draw": "距离今日开奖",
      "countdown_hours": "时",
      "countdown_minutes": "分",
      "countdown_seconds": "秒",
      "daily_draw_at_21": "每晚 21:00 准时开奖",
      "join_now_btn": "立即参与抽奖",
      "day_prize_detail": "第 {{day}} 天奖品详情",
      "daily_prize_label": "当日奖品",
      "winner_info": "中奖信息",
      "draw_time": "开奖时间",
      "no_winner": "无人中奖",
      "waiting_draw": "等待开奖",
      "tonight_21_draw": "今晚 21:00 开奖",
      "daily_disclaimer_text": "本活动为 HUNSOCCER 平台举办的虚拟预测竞猜活动，所有奖品抽取结果由系统随机生成，与任何形式的赌博或博彩活动无关。参与者需年满18周岁，活动最终解释权归 HUNSOCCER 所有。奖品发放需中奖者在7日内完成身份验证及收货地址确认，逾期视为自动放弃。",
      "daily_today": "今天",
      "disclaimer": "免责声明",
      ...
      "matches_suffix": "场",
      "challenge_ai": "挑战AI",
      "challenge_ai_reward": "挑战AI奖励",
      "big_prize_waiting": "大奖等你来拿",
      "challenge_description": "预测场次，预测准确率，模拟额度在规定时间内都超过当前排名第一的AI模型，即可免费领取奖金",
      "ai_benchmark": "AI基准",
