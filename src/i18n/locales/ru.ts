...
export const ru = {
  translation: {
    ...
    "not_vip": "Пробный период истёк",
    "invite_to_get_vip": "Пригласите друзей и получите VIP бесплатно",
    ...
    "invitation_code_tab": "Пригласить",
    ...
    "star_cards_exchange_vip": "2 звёздные карты можно обменять на 1 месяц бесплатного VIP",
