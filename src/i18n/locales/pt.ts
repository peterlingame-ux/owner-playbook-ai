...
export const pt = {
  translation: {
    ...
    "virtual_bet_label": "Aposta Virtual",
    "profit_rate_label": "Taxa de Lucro",
    "followers_count": "Seguidores",
    "tracking_users": "Usuários Seguindo",
    "updated_at": "Atualizado em",
    "rank_header": "Posição",
    "profit_and_scale": "Lucro | Participação",
    "hunter_coin_and_scale": "Hunter Coin | Participação",
    "followed_times": "Seguiu {{count}} vezes",
    ...
    "consecutive_wins": "vitórias consecutivas",
    "consecutive_losses": "derrotas consecutivas",
    "current_streak": "Sequência Atual",
    "best_streak": "Melhor Sequência",
    "worst_streak": "Pior Sequência",
    "streak_count": "{{count}} sequência",
    "correct_label": "Correto",
    "wrong_label": "Incorreto",
    "correct_count_label": "{{count}} corretos",
    "wrong_count_label": "{{count}} incorretos",
    "win_badge": "V",
    "loss_badge": "D",
    "people_suffix": "",
    "matches_suffix": "",
    ...
    "no_matches": "Nenhuma partida disponível",
    "retry": "Tentar novamente",
    "soon": "Em breve",
    "match_tab_all": "Todas",
    "match_tab_live": "Ao Vivo",
    "match_tab_upcoming": "Próximas",
    "match_tab_finished": "Resultados",
    "match_tab_favorites": "Favoritos",
    
    // Prize
    "prize_share": "Parte do Prêmio",
    "estimated": "Estimado",
    "reach_qualification_for_prize": "Qualifique-se para o prêmio",
    ...
    "join_competition": "Registrar / Entrar",
    ...
    "auth": {
      ...
      "not_vip": "Período de teste expirado",
      "invite_to_get_vip": "Convide amigos e ganhe VIP grátis",
      ...
      "free_trial_expired": "Período de teste gratuito expirado",
      "free_trial_expired_contact": "Período de teste gratuito expirou. Entre em contato com o atendimento ao cliente.",
      "free_trial_7_days_title": "7 dias de teste gratuito",
      "free_trial_7_days_desc": "Você tem 7 dias de teste gratuito para aproveitar todos os recursos.",
      "free_trial_ends_at": "Teste termina em",
    ...
    "fetch_balance_failed": "Falha ao obter saldo",
    "please_try_later": "Tente novamente mais tarde",
    "insufficient_balance_title": "Saldo Insuficiente",
    "current_balance_need": "Saldo atual: {{current}}, necessário: {{need}}",
    "subscribe_success": "Assinatura Bem-sucedida!",
    "subscribed_model": "Assinado {{model}}, investido {{amount}} Hunter Coins",
    "subscribe_failed": "Falha na Assinatura",
    "login_first": "Faça Login Primeiro",
    "login_to_subscribe": "Faça login para assinar modelos de IA",
    "fetch_analysis_failed": "Falha ao Obter Análise",
    "cannot_fetch_analysis": "Não foi possível obter dados de análise",
    "no_analysis_found": "Nenhuma Análise Encontrada",
    "no_analysis_data": "Sem dados de análise de IA para esta partida",
    "fetch_training_failed": "Falha ao obter histórico de treinamento",
    "fetch_match_list_failed": "Falha ao obter lista de partidas",
    ...
    "all_predictors": "Todos os Previsores",
    "copy_profit_label": "Lucro de Cópia",
    "followers_suffix": " seguidores",
    "90d_copy_profit": "Lucro 90D",
    ...
    "sort_comprehensive": "Ordenação Integral",
    "sort_win_rate": "Por Taxa de Vitória",
    "sort_profit": "Por Lucro",
    "sort_followers": "Por Seguidores",
    "ranking_rules": "Condições e Regras do Ranking",
    "rule_predictions": "Previsões ≥ 10",
    "rule_winrate": "Taxa de Vitória ≥ 50%",
    "rule_days": "Dias Ativos ≥ 7",
    "rule_sort": "O ranking integral é baseado em taxa, lucro e seguidores",
    "winning_model": "Modelo Vencedor",
    "active_matches": "Partidas Ativas",
    "league_premier_league": "Premier League",
    "league_la_liga": "La Liga",
    "league_bundesliga": "Bundesliga",
    "win_rate_label": "Taxa de Vitória",
    "correct_predictions_label": "Previsões Corretas",
    ...
    "cancel": "Cancelar",
    "confirm": "Confirmar",
    "follow_player_title": "Seguir Jogador",
    "follow_player_confirm": "Tem certeza que deseja seguir {{name}}?",
    "follow_success": "Agora você segue {{name}}",
    "auto_prediction": "Auto",
    "manual_prediction": "Manual",
    "potential_win": "Ganho potencial",
    "confirm_bet": "Confirmar aposta",
    "demo_prediction_success": "Previsão demo bem-sucedida",
    "handicap_bet": "Handicap",
    "over_under_bet": "Mais/Menos",
    "over": "Mais",
    "under": "Menos",
    "bet_amount": "Valor da aposta",
    "bet_success": "Previsão enviada com sucesso",
    ...
    // VIP Dialog
    "open_vip": "Ativar Membro VIP",
    "vip_unlock_privileges": "Desbloqueie privilégios exclusivos e aproveite a experiência VIP",
    "vip_enjoy_privileges": "Aproveite os privilégios exclusivos",
    "vip_active": "VIP Ativo",
    "vip_privilege_avatar": "Avatar Personalizado",
    "vip_privilege_avatar_desc": "Carregue e altere seu avatar pessoal",
    "vip_privilege_matches": "Acesso Gratuito às Partidas",
    "vip_privilege_matches_desc": "Acesso gratuito a todos os dados e análises de partidas",
    "vip_privilege_entrance": "Efeito de Entrada Especial",
    "vip_privilege_entrance_desc": "Efeito legal ao entrar no chat da partida",
    "vip_privilege_glow": "Nome Brilhante",
    "vip_privilege_glow_desc": "Seu nome brilha no ranking",
    "vip_privilege_dm": "Mensagens Privadas",
    "vip_privilege_dm_desc": "Converse em privado com outros jogadores",
    "vip_price": "Preço de Ativação",
    "open_vip_now": "Ativar VIP Agora",
    "vip_purchase_success": "VIP Ativado com Sucesso!",
    "vip_purchase_failed": "Falha na Ativação",
    "vip_status_active": "Membro VIP Ativo",
    "vip_not_available": "Funcionalidade VIP ainda não disponível",
    "enjoy_all_privileges": "Aproveite todos os privilégios exclusivos",
    ...
    "invites": "convites",
    "invite_friends": "Convide amigos para desbloquear mais",
    ...
    "total_won_stat": "Total Ganho",
    "correct_predictions_count": "Corretas",
    "personal_records": "Estatísticas",
    "invitation_code_tab": "Convidar",
    "history_records": "Histórico",
    "your_invitation_code": "Seu Código de Convite",
    "invited_count": "Convidados",
    "invite_reward_title": "Recompensa Carta Estrela",
"invite_reward_desc": "Convide 5 amigos para 1 carta",
   "star_cards_exchange_vip": "2 cartas estrela podem ser trocadas por 1 mês de VIP grátis",
   "star_cards_earned": "{{count}} cartas ganhas",
    "total_invited": "{{count}} convidados",
